...
-- InsertContact procedure call SelectContact procedure
-- DROP PROCEDURE IF EXISTS dbo.SelectContact;
IF EXISTS(SELECT 1 FROM sys.procedures WHERE [name] = 'SelectContact')
	BEGIN;
...
-- 02 create procedure with parameters
